...
export default class ClaudianPlugin extends Plugin {
  ...
  async onload() {
    ...
    this.addCommand({
      id: 'generate-neurolex-session-plan',
  ...
  private getNeuroLexNotesRoot(): string {
    const normalized = this.settings.neurolexNotesFolder.trim().replace(/^\/+|\/+$/g, '');
